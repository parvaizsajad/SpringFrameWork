				...
				<form action="${pageContext.request.contextPath }/updateForm" method="post">
					<div class="text-center">
						...
						<label for="exampleInputEmail1"></label> <input
							...
							aria-describedby="emailHelp" placeholder="Enter Product Name" name="id" value="${product.id }"> 
						
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">Product Name</label> <input
							type="text" class="form-control" id="exampleInputEmail1"
							aria-describedby="emailHelp" placeholder="Enter Product Name" name="name" value="${product.name }"> 
						
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Product Description</label> 
						<textarea rows="3" cols="3"  class="form-control" name="pDesc"  placeholder="Enter Description here..">${product.pDesc }</textarea>
					<div class="form-group"> 
						<label for="exampleInputEmail1">Product price</label> <input
							type="text" class="form-control" id="exampleInputEmail1"
							aria-describedby="emailHelp" placeholder="Enter Product price" name="pPrice" value="${product.pPrice}"> 
